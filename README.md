...
Use the incremental kernel first; if it is still too slow, the next core step is a precomputed-window point walking implementation and lower-level field arithmetic optimization.
